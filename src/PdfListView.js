...
PageView.prototype = {
    ...
    createNewCanvas: function() {
        ...
        this.loadingIconDiv.setAttribute('style', SPINNER_STYLE);
        this.dom.appendChild(this.loadingIconDiv);
    },
        ...
        if (!renderContext) {
            ...
            renderContext.renderPromise.then(
              function pdfPageRenderCallback() {
                ...
                // remove loading icon
                pageView.dom.removeChild(pageView.loadingIconDiv);
                delete pageView.loadingIconDiv;
